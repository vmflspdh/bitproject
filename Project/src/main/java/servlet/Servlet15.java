...
public class Servlet15 extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
    //getParameter()를 호출하기 전에 데이터를 꺼내는데 사용할 문자표를 지정한다.
    //=> 만약 문자표를 지정하지 않는다면, 기본 문자표 ISO-8859-1을 사용한다.
    //   즉 클라이언트가 보내는 데이터에 대해 조회할때   ISO-8859-1 문자표를 사용한다는 의미이다.
    //   문제는 한글 데이터를 ISO-8859-1에 정의되어 있지 않기 때문에
    //   영어로 간주하고 유니코드로 변환한다.
