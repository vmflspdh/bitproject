...
$(document.body).on('click', '.selectAddBtn', function(event) {
	...
	var newroot = $("#root-select tr:last");
	newroot.after(
			newroot.clone()
			.removeClass()
			.addClass((parseInt(lastrootNo)+1) + " root")
	...
	var className = newroot.attr("class");
	console.log(className)

	var indexRow = $(this).parent().parent();
	console.log(indexRow)
	newroot.insertAfter(indexRow);
